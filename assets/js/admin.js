...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@ext-landing/controllers/option-controller.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function route() {
  ...
  switch (pagePath) {
    case 'option':
      controller = new !(function webpackMissingModule() { var e = new Error("Cannot find module '@ext-landing/controllers/option-controller.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
      break;
